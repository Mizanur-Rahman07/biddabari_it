...
class CourseController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if (!empty($request->category_id))
        {
            ...
            $this->courses = Course::where('parent_id', 0)->orderBy('id', 'DESC')->select('id','title','price','banner','is_featured', 'duration_in_month','discount_type', 'discount_amount', 'is_paid','status')->paginate(500);
        }
