...
{{--                    <input type="text" value="{{ isset($course->featured_video_url) ? 'https://youtu.be/'.$course->featured_video_url : '' }}" name="featured_video_url" class="form-control" placeholder="Featured Video" />--}}
                    <input type="text" value="{{ isset($course->featured_video_url) ? 'https://www.youtube.com/watch?v='.$course->featured_video_url : '' }}" name="featured_video_url" class="form-control" placeholder="Ex:- https://www.youtube.com/watch?v=o8ENSjeWip4" />
