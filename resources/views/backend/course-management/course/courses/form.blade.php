...
{{--                    </select>--}}
                ...
                <div class="col-md-12 mt-2 mb-2">
                    ...
                    <textarea name="whythiscourse" class="form-control whythiscourse" id="whythiscourse" placeholder="Why this course?" cols="30" rows="5"></textarea>
...
{{--                        <option value=""></option>--}}
                ...
                <div class="col-md-6 mt-2">
                    ...
                    <input type="text"  name="featured_video_url" class="form-control" placeholder="Ex:- https://www.youtube.com/watch?v=o8ENSjeWip4" />
