									...
									<div class="tab-pane fade" id="instructors" role="tabpanel" aria-labelledby="instructors-tab">
										<div class="single_instructor">
											<div class="single_instructor_thumb">
												<a href="#"><img src="{{asset('frontendAsset')}}/assets/img/user-4.jpg" class="img-fluid" alt=""></a>
											</div>
						...
						<div class="col-lg-4 col-md-12  order-lg-last">
							...
							<div class="ed_view_box style_3 ovrlio stick_top">
								...
								<div class="property_video sm">
									<div class="thumb">
										<img class="pro_img img-fluid w100" src="{{asset('frontendAsset')}}/assets/img/banner-3.jpg" alt="7.jpg">
