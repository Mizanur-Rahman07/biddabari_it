@extends('frontend.dashboard.student_dashboard')
@section('title')
Biddabari IT || Profile
@endsection
                        ...
                        <div class="col-xl-12 col-lg-12 col-md-12">
                            <form>
                                <div class="form-group smalls">
                                    ...
                                    <input type="text" class="form-control" value="Suraj" />
                                </div>
                                <div class="form-group smalls">
                                ...
                                <div class="form-group smalls">
                                    <label>Email</label>
                                    <input type="email" class="form-control" value="support@themezhub.com" />
                                </div>
                                <div class="form-group smalls">
                                    <label>Phone</label>
