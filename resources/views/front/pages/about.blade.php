        ...
        <div class="container">
            <div class="row align-items-center justify-content-between">
                    ...
                    <div class="lmp_caption">
                        ...
                        <div class="mb-3 mr-4 ml-lg-0 mr-lg-4">
                            <div class="d-flex align-items-center">
                                ...
                                <h6 class="mb-0 ml-3">Free Guideline lifetime</h6>
                            </div>
                        </div>
                ...
                <div class="col-xl-5 col-lg-5 col-md-12 col-sm-12">
                    <div class="lmp_thumb">
                        <img src="{{asset('frontendAsset')}}/assets/img/lmp-2.png" class="img-fluid" alt="" />
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-6">
                    <div class="crs_partn">
                        <div class="p-3">
                            <img src="{{asset('frontendAsset')}}/assets/img/lg-1.png" class="img-fluid" alt="" />
                        </div>
                    </div>							
                </div>
                ...
                <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-6">
                    <div class="crs_partn">
                        <div class="p-3">
                            <img src="{{asset('frontendAsset')}}/assets/img/lg-2.png" class="img-fluid" alt="" />
                        </div>
                    </div>							
                </div>
                ...
                <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-6">
                    <div class="crs_partn">
                        <div class="p-3">
                            <img src="{{asset('frontendAsset')}}/assets/img/lg-3.png" class="img-fluid" alt="" />
                        </div>
                    </div>							
                </div>
                ...
                <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-6">
                    <div class="crs_partn">
                        <div class="p-3">
                            <img src="{{asset('frontendAsset')}}/assets/img/lg-4.png" class="img-fluid" alt="" />
                        </div>
                    </div>							
                </div>
                ...
                <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-6">
                    <div class="crs_partn">
                        <div class="p-3">
                            <img src="{{asset('frontendAsset')}}/assets/img/lg-5.png" class="img-fluid" alt="" />
                        </div>
                    </div>							
                </div>
                ...
                <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-6">
                    <div class="crs_partn">
                        <div class="p-3">
                            <img src="{{asset('frontendAsset')}}/assets/img/lg-6.png" class="img-fluid" alt="" />
                        </div>
                    </div>							
                </div>
                ...
                <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-6">
                    <div class="crs_partn">
                        <div class="p-3">
                            <img src="{{asset('frontendAsset')}}/assets/img/lg-7.png" class="img-fluid" alt="" />
                        </div>
                    </div>							
                </div>
                ...
                <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-6">
                    <div class="crs_partn">
                        <div class="p-3">
                            <img src="{{asset('frontendAsset')}}/assets/img/lg-8.png" class="img-fluid" alt="" />
                        </div>
                    </div>							
                </div>
                ...
                <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-6">
                    <div class="crs_partn">
                        <div class="p-3">
                            <img src="{{asset('frontendAsset')}}/assets/img/lg-9.png" class="img-fluid" alt="" />
                        </div>
                    </div>							
                </div>
