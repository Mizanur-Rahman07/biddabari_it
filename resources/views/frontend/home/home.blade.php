            ...
            <div class="col-md-3 col-m-6">
                <div class="categories-item">
                    <a
                        ...
                        <img loading="lazy" src="{{ asset(isset($courseCategory->image) ? $courseCategory->image : 'frontend/logo/biddabari-card-logo.jpg') }}"
            ...
            <div class="col-lg-3 col-md-6">
                <div class="blog-card">
                    ...
                    <div class="blog_card_img">
                            ...
                            <img loading="lazy" src="{{ asset($product->image ?? 'frontend/logo/biddabari-card-logo.jpg') }}"
                                alt="{{ $product->title }}">
        ...
        <div class="row facility">
            ...
            <div class="col-12 col-m-6">
                <div class="card mb-4 border-0 content-shadow">
                    <div class="row g-0">
                        <div class="col-md-4">
                            <img loading="lazy" src="{{ asset($ourService->image) ?? 'frontend/assets/images/our-speak/1.png' }}"
                ...
                <div class="tab-pane fade show active" id="home-tab-pane" role="tabpanel" aria-labelledby="home-tab"
                    ...
                    <div class="testimonials-slider-two owl-carousel owl-theme">
                        ...
                        <div class="testimonials-card-two">
                            ...
                            <div class="content">
                                <img loading="lazy" src="{{ asset($successStudentOpinion->image) ?? 'frontend/assets/images/testimonials/s-1.jpg' }}"
                                    alt="testimonials" />
                ...
                <div class="tab-pane fade" id="profile-tab-pane" role="tabpanel" aria-labelledby="profile-tab"
                    ...
                    <div class="testimonials-slider-two owl-carousel owl-theme">
                        ...
                        <div class="testimonials-card-two">
                            ...
                            <div class="content">
                                <img loading="lazy" src="{{ asset($runningStudentOpinion->image) ?? 'frontend/assets/images/testimonials/s-1.jpg' }}"
                                    alt="testimonials" />
