            ...
            <div class="row">
                <div class="col-lg-12 col-md-12">
                    ...
                    <div class="breadcrumbs-wrap">
                        <h1 class="breadcrumb-title">All Notices</h1>
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb p-0 bg-white">
                                <li class="breadcrumb-item"><a href="{{ url('/') }}" wire:navigate>Home</a></li>
                                <li class="breadcrumb-item active theme-cl" aria-current="page">Notices</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                    ...
                    <div class="card">
                        ...
                        @forelse($notices as $notice)
                            <div class="card-body py-2 border-bottom">
                                <a href="{{ route('front.notices', ['notice-id' => $notice->id]) }}" class="w-100" wire:navigate >
                                    <div class="row">
